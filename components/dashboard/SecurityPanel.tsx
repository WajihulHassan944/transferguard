      ...
      <Card className="p-6">
        ...
        {loadingHistory ? (
          ...
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p className="text-xs mt-1">We're working on tracking login activity for your security.</p>
          </div>
        ) : (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-sm">
                      {getDeviceName(event.user_agent)}
                    </p>
                    <p className="text-xs text-muted-foreground">
                      {event.ip_address || "Unknown IP"} • {new Date(event.timestamp).toLocaleString()}
                    </p>
                  </div>
                </div>
                {event.success ? (
